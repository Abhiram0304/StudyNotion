...
const Upload = ({name,label,setValue,register,video,errors}) => {
                            ...
                            <div className='w-[90%] h-[90%] rounded-lg overflow-hidden flex flex-col gap-[1rem] justify-center items-center object-cover'>
                                {
                                    !video ? 
                                        ...
                                        : 
                                        (<Player src={preview} className='w-full h-full object-cover rounded-lg' aspectRatio='16:9' playsInline={true} />)
                                }
                        ...
                        (
                            <div className='w-full h-full' {...getRootProps()}>
                                ...
                                <div className='px-[1rem] flex justify-center items-center flex-col gap-[0.5rem]'>
                                    ...
                                    <ul className='w-full flex md:flex-row flex-col justify-evenly items-center list-disc'>
